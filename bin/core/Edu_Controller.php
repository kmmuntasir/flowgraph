...
class Admin_Controller extends Edu_Controller {

    public $module = 'admin';   // defines the module
    public $template = 'optima_edu_admin';  // Current Template Name
...
class Student_Controller extends Edu_Controller {

    public $module = 'student';   // defines the module
    public $template = 'optima_edu_student';  // Current Template Name
...
class Teacher_Controller extends Edu_Controller {

    public $module = 'teacher';   // defines the module
    public $template = 'optima_edu_teacher';  // Current Template Name
