...
$db['production']['db_debug'] = (ENVIRONMENT !== 'production');
$db['production']['cache_on'] = FALSE;
$db['production']['cachedir'] = '';
$db['production']['char_set'] = 'utf8';
$db['production']['dbcollat'] = 'utf8_unicode_ci';
$db['production']['swap_pre'] = '';
$db['production']['encrypt'] = FALSE;
$db['production']['compress'] = FALSE;
...
$db['development']['database'] = 'flowgraph';
$db['development']['dbdriver'] = 'mysqli';
$db['development']['dbprefix'] = '';
$db['development']['pconnect'] = FALSE;
$db['development']['db_debug'] = (ENVIRONMENT !== 'development');
$db['development']['cache_on'] = FALSE;
$db['development']['cachedir'] = '';
$db['development']['char_set'] = 'utf8';
$db['development']['dbcollat'] = 'utf8_unicode_ci';
$db['development']['swap_pre'] = '';
$db['development']['encrypt'] = FALSE;
$db['development']['compress'] = FALSE;
$db['development']['stricton'] = FALSE;
$db['development']['failover'] = array();
$db['development']['save_queries'] = TRUE;
...
$db['testing']['db_debug'] = (ENVIRONMENT !== 'testing');
$db['testing']['cache_on'] = FALSE;
$db['testing']['cachedir'] = '';
$db['testing']['char_set'] = 'utf8';
$db['testing']['dbcollat'] = 'utf8_unicode_ci';
$db['testing']['swap_pre'] = '';
$db['testing']['encrypt'] = FALSE;
$db['testing']['compress'] = FALSE;
$db['testing']['stricton'] = FALSE;
$db['testing']['failover'] = array();
$db['testing']['save_queries'] = TRUE;